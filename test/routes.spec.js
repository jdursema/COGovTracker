    ...
    it('should return all of the candidates', () => {
      return chai.request(server)
        ...
        .then(response => {
          ...
          const foundCandidate= response.body.candidates.find( candidate => 
            candidate.last_name === 'Ginsburg');
          ...
          foundCandidate.image.should
            .equal('http://msantray.fatcow.com/governor_photos/noel_ginsburg.jpeg');
    ...
    it('should return all of the contributions', () => {
      return chai.request(server)
        ...
        .then(response => {
          ...
          const foundCandidate = response.body.contributors.find( contributor =>
            contributor.donor_last === 'SHIPPS');
